...
public class calculator1 {
    ...
    public static void main(String[] args) {
        ...
        else if (average >= 80 & average <=89.99) { // Used AI to find out it is typed as "else if" as I previously knew it as elif in python
            System.out.print("Your letter grade is: B"); 
        }
        else if (average >= 70 & average <=79.99) { // Code keeps checking specific requirements for the letter grades
            System.out.print("Your letter grade is: C");
        }
        else if (average >= 60 & average <=69.99) { // For grade D
            System.out.print("Your letter grade is: D");
        }
        else if (average < 60) { // Basically means your failing
